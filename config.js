...
// Difix Oleh PutraModz
// Ditulis Ulang Oleh ZIRO
...
global.snh = 'https://chat.whatsapp.com/FQH6CI63LJCBTySzClHrrg' //Hmmm, Ini boleh kalian isi terserah :v
...
/*============== NOMOR ==============*/
global.nomorbot = '62823504965329' //Nomor Bot
global.nomorown = '62823504965328' //Nomor Owner
global.namebot = 'ɴᴇᴏʙᴏᴛᴢ-ᴠ.2' //Nama Bot
global.nameown = 'ɪ ᴀᴍ ғᴇʀᴅʏ' // Nama Owner
global.wame = 'https://api.whatsapp.com/send?phone=+62823504965328'


/*============== STAFF ==============*/
global.owner = [
  ['62823504965328', 'ɪ ᴀᴍ ғᴇʀᴅʏ', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ɴᴇᴏʙᴏᴛᴢ ᴠ.2  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ɴᴇᴏʙᴏᴛᴢ ᴠ.2 ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ɴᴇᴏʙᴏᴛᴢ ᴍᴅ ᴠ.2'
global.namedoc = 'ɴᴇᴏʙᴏᴛ ᴠ.2' //Main Name Menu Document
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = '🎋 ┊ ɴᴇᴏ ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
...
/*============== TEXT ==============*/
global.wait = pickRandom(["sᴀʙᴀʀ.... 98% 𝚠𝚊𝚒𝚝!!", "Wᴀɪᴛɪɴɢ", "「▰▰▰▱▱▱▱▱▱▱」ʟ ᴏ ᴀ ᴅ ɪ ɴ ɢ..."])
global.eror = '```404 error```'
global.dtu = 'ɪɴꜱᴛᴀɢʀᴀᴍ'
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = '+62 823 5049 6532'
...
global.packname = 'ɴᴇᴏʙᴏᴛᴢ ᴀʟʟ ʀᴇsᴇʀᴠᴇʀᴇᴅ'
global.packname2 = 'ɴᴇᴏ ʙᴏᴛ ᴍᴅ\n\n\n\n\n\n\n\n\n\n© 2021-2023\n\n\nʙʏ ғᴇʀʀᴢxx'
